...
.LC0:
	.string	" %x "
.LC1:
	.string	"too big IO physical address"
	.text
	.globl	ioremap
	.type	ioremap, @function
ioremap:
.LFB54:
	.file 1 "../src/arch/x86/mm/ioremap.c"
	.loc 1 4 0
	.cfi_startproc
	pushl	%ebp
...
.Ldebug_macro0:
	...
	.uleb128 0x6
	.byte	0x4
	.file 13 "./arch/x86/include/asm/page.h"
	.byte	0x3
	.uleb128 0x5
	.uleb128 0xd
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 16 "./arch/x86/include/asm/io.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0x10
	.byte	0x5
...
.LASF393:
	.string	"../src/arch/x86/mm/ioremap.c"
.LASF282:
