...
.LFE22:
	...
	.data
	.align 4
	.type	selector_plain_d, @object
	.size	selector_plain_d, 16
selector_plain_d:
	.long	selector_plain_d0
	.long	selector_plain_d1
	.long	0
	.long	selector_plain_d3
	.align 4
	.type	selector_plain_c, @object
	.size	selector_plain_c, 16
selector_plain_c:
	.long	selector_plain_c0
	.long	selector_plain_c1
	.long	0
	.long	selector_plain_c3
	.globl	__eflags
	.align 4
	.type	__eflags, @object
	.size	__eflags, 4
__eflags:
	.long	4608
	.section	.rodata
...
.LC1:
	...
	.align 4
.LC2:
	.string	"MEMBER_OFFSET(struct pcb, need_resched) == (u32)&NEED_RESCHED_OFFSET"
	.text
	.globl	init_pcb
	.type	init_pcb, @function
init_pcb:
.LFB51:
	.file 2 "proc.c"
	.loc 2 14 0
	...
	subl	$24, %esp
	.loc 2 16 0
	movl	$NEED_RESCHED_OFFSET, -12(%ebp)
	.loc 2 17 0
	movl	$0, -16(%ebp)
	.loc 2 18 0
	movl	-12(%ebp), %eax
...
.L5:
	...
	movl	8(%ebp), %eax
	movl	$-1430532899, 136(%eax)
	.loc 2 46 0 discriminator 1
	movl	8(%ebp), %eax
	movl	$0, 56(%eax)
	.loc 2 56 0 discriminator 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
	ret
	.cfi_endproc
.LFE51:
	.size	init_pcb, .-init_pcb
	.section	.rodata
.LC3:
	.string	"new process:baby addr:%x\n"
.LC4:
	.string	"baby"
	.text
...
.LBE3:
	...
	.cfi_endproc
.LFE53:
	.size	obuffer_init, .-obuffer_init
	.section	.rodata
.LC5:
	.string	"pt_obuffer->num<size_buffer"
	.text
	.globl	obuffer_push
	.type	obuffer_push, @function
obuffer_push:
.LFB54:
	.loc 2 77 0
	.cfi_startproc
...
.L21:
	...
	.cfi_endproc
.LFE54:
	.size	obuffer_push, .-obuffer_push
	.globl	obuffer_shift
	.type	obuffer_shift, @function
obuffer_shift:
.LFB55:
	.loc 2 86 0
	.cfi_startproc
...
.L24:
	...
	.cfi_endproc
.LFE55:
	.size	obuffer_shift, .-obuffer_shift
	.section	.rodata
.LC6:
	.string	"\n at %x "
.LC7:
	.string	"get ill current"
	.text
	.globl	get_current
...
.LFE57:
	...
	.align 4
.LC8:
	.string	"p_name:%s entry:%x prio:%u time_slice:%u\n"
	.text
	.globl	pcb_info
	.type	pcb_info, @function
pcb_info:
.LFB58:
	.loc 2 112 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE58:
	.size	pcb_info, .-pcb_info
	.section	.rodata
.LC9:
	.string	"p->mm == 0"
	.text
	.globl	fire_thread
	.type	fire_thread, @function
fire_thread:
.LFB59:
	.loc 2 157 0
	.cfi_startproc
...
.Ldebug_macro0:
	...
	.uleb128 0xe4
	.long	.LASF227
	.file 15 "./include/old/asm_lable.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0xf
	.byte	0x5
...
.LASF557:
	.string	"selector_plain_c"
.LASF556:
	.string	"selector_plain_d"
.LASF242:
...
.LASF391:
	.string	"PCB_MAGIC_NUMBER 0xaabbccdd"
.LASF75:
...
.LASF568:
	.string	"selector_plain_d0"
.LASF570:
	.string	"selector_plain_d1"
.LASF572:
