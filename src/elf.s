...
.LC0:
	...
	.align 4
.LC1:
	.string	"img[1] == 'E' && img[2]=='L' && img[3] == 'F'"
	.text
	.type	set, @function
set:
.LFB42:
	...
	cmpb	$69, %al
	jne	.L2
	.loc 1 7 0 is_stmt 0 discriminator 2
	movl	8(%ebp), %eax
	addl	$2, %eax
	movzbl	(%eax), %eax
	cmpb	$76, %al
...
.Ldebug_macro1:
	...
	.long	.LASF241
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.elf.h.35.40a0575e1225334cfdb7133a292ccce7,comdat
.Ldebug_macro2:
	.value	0x4
	.byte	0
	.byte	0x5
