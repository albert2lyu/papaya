...
syn keyword	cStatement	goto break return continue asm 返回
syn keyword	cLabel		case default
syn keyword	cConditional	if else switch 若 否则
syn keyword	cRepeat		while for do 只要 对于 执行

syn keyword	cTodo		contained TODO FIXME XXX BUG BREAK
